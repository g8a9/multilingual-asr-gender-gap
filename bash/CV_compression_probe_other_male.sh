...
LANGS=( "de" "en" "ca" "es" "fr" )

OUTPUT_DIR="./results-interim-asr-performance-gap/gender_probing_other_male"
EMB_DIR="/data/milanlp/attanasiog/fair_asr/compression_other_male"
mkdir -p ${OUTPUT_DIR}
